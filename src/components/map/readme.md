...
| `markerClassIcon`     | `marker-class-icon`     | The class that the marker will have.                                                                                                                                                                                         | `string`                                | `"gx-default-icon"`    |
...
| `showMyLocation`      | `show-my-location`      | `true` to indicate if the current location marker is shown on the map.                                                                                                                                                       | `boolean`                               | `undefined`            |
| `watchPosition`       | `watch-position`        | Indicates if the current location of the device is displayed on the map.                                                                                                                                                     | `boolean`                               | `false`                |
