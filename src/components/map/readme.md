...
| --------------------- | ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------- | ---------------------- |
| `ShowMyLocation`      | `show-my-location`      | Indicates if the current location marker is shown on the map. \_                                                                                                                                                             | `boolean`                               | `undefined`            |
...
| `markerClassIcon`     | `marker-class-icon`     | The class that the marker will have. \_                                                                                                                                                                                      | `string`                                | `"gx-default-icon"`    |
