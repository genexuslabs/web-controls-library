...
| --------------- | ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- | -------------- |
| `direction`     | `direction`      | Specifies how the child `gx-radio-option` will be layed out. It supports two values: _ `horizontal` _ `vertical` (default)                                                                                                                                                                                                                                                                   | `"horizontal" \| "vertical"` | `"horizontal"` |
