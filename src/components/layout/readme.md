...
| `renderMainRole`         | `render-main-role`          | This attribute lets you specify whether the main content should be contained in a tag that has role=`"main"`. If `false`, the main content will be contained in a generic tag (<div>). | `boolean`                        | `true`    |
