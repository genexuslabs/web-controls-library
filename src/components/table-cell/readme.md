...
| `showContentFade` | `show-content-fade` | True to add a fading overlay on the right and bottom area of the cell to signify that the content is longer thant the space allows.                                                                                                                                                                                                | `boolean`                       | `false`     |
