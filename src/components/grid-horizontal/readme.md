...
| `pageControllerClass` | `page-controller-class` | A CSS class to set as the Page Controller element class when `showPageController = "true"`.                                                                                                                                                                                                                                                                                                                                                                                                        | `string`                     | `undefined`  |
...
| `showPageController`  | `show-page-controller`  | If `true`, show the pagination buttons (page controller).                                                                                                                                                                                                                                                                                                                                                                                                                                          | `boolean`                    | `true`       |
...
| `--gx-page-controller-indicator-selected-color`   | The fill color used for the page controller indicator when selected.                                               |
| `--gx-page-controller-indicator-unselected-color` | The fill color used for the page controller indicator when unselected.                                             |
