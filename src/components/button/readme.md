...
| `"disabled-image"` | The caption displayed at the center of the control.                                                                                                                                                            |
| `"main-image"`     | The img displayed in the position indicated by the imagePosition property. This part is only available if the main image src is defined and the {control is not disabled \| the disabled image is not defined} |
