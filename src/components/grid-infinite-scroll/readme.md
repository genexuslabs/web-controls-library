...
| `viewportSelector` | `viewport-selector` | The View Port parent element selector where the infinite component is attached to and listening to Scroll Events.                                                                                                                                                                                                                                                                                         | `string`            | `"." + GridBaseHelper.GRID_BASE_CLASSNAME` |
