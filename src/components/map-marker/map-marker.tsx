...
export class MapMarker implements IComponent {
  ...
  componentDidLoad() {
    ...
    if (regExp.test(this.coords)) {
      this.markerInstance = marker(
        [this.coords.split(",")[0].trim(), this.coords.split(",")[1].trim()],
        {
          icon: icon({
            iconAnchor: [12, 41],
            iconSize: [25, 41],
